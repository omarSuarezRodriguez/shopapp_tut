...
class WallScreenCliente extends StatefulWidget {
  @override
  _WallScreenClienteState createState() => _WallScreenClienteState();
}

class _WallScreenClienteState extends State<WallScreenCliente> {
